...
frame = Frame(width=400, height=400, bg="#C0C0C0")
frame.place(x=650, y=250)

title = Label(N, text="MESSAGE ENCODE AND DECODE", font=("Times New Roman",20,"bold"))
title.place(x=500, y=70)

lbl = Label(N, text="developed by Selvakumar", font=("Times New Roman",16,"bold"))
lbl.place(x=1100, y=650)

btn_encode = Button(N, text="ENCODE", font=("Times New Roman",12,"bold"), command=encode_message)
btn_encode.place(x=750, y=300)

btn_decode = Button(N, text="DECODE", font=("Times New Roman",12,"bold"), command=decode_message)
